...
const QUALITY_RENDER_SCALE = 10; // render at ultra-extreme resolution to improve clarity in Word
const MIN_OUTPUT_WIDTH_PX = 61440; // 64K width target
const MIN_OUTPUT_HEIGHT_PX = 34560; // 64K height target

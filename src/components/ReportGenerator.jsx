...
const QUALITY_RENDER_SCALE = 7; // render at even higher resolution to improve clarity in Word/PDF
const MIN_OUTPUT_WIDTH_PX = 5120;
const MIN_OUTPUT_HEIGHT_PX = 2880;
